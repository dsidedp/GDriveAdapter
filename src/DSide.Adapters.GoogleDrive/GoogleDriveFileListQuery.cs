...
namespace DSide.GoogleDrive
{
    ...
    public class GoogleDriveFileListQuery
    {
        ...
        public IReadOnlyDictionary<string, string> Properties { get; private set; } = null;
        ...
        public static GoogleDriveFileListQuery FromFile(IGoogleDriveFile file) => new GoogleDriveFileListQuery { Name = file.Name, Properties = new ReadOnlyDictionary<string, string>(file.Properties) };
        ...
        private class Visitor : ExpressionVisitor
        {
            ...
            private static bool TryEvalConditional(ConditionalExpression node) => (bool)Expression.Lambda(node.Test).Compile().DynamicInvoke();
